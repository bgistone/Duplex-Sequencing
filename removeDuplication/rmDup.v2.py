...
# Start going through the input BAM file, one position at a time.
	...
	tag_stats(o.tag_file+".pos.count", o.tag_stats+".pos.stat")
	tag_stats(o.tag_file+".postag.R1.count", o.tag_stats+".postag.R1.stat")
	tag_stats(o.tag_file+".postag.RF.count", o.tag_stats+".postag.RF.stat")
